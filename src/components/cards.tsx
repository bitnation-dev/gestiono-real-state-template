...
const Card = ({  multimedia, price, location, bedrooms, bathrooms, parking, meters, onClick }: CardProps) => {
    ...
    return (
        ...
        <div className="relative">
                {multimedia ? <Image onClick={onClick} width={500} height={500} src={multimedia} alt=""  className="aspect-square size-72 object-cover"/> : <div className="w-full h-full bg-gray-200"> No Image Available</div>}
            ...
            <div className=" flex space-x-4 py-4" >
                ...
                <p className="text-sm text-black pt-2"> {meters ? meters + " m2" : "- m2"} </p>
            </div>
            ...
            <p className="text-sm text-[#3B4504] pt-2 flex flex-col justify-end">{location ? location : "-"}</p>
        </div>
    )
}
